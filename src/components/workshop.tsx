    ...
    <div className="">
      ...
      <div className="ml-4 flex pt-3">
        ...
        <h4 className="ml-4 pb-6 text-sm text-gray-600">
          {workshop.section == "AOK" ? "ÁOK" : workshop.section == "ALL" ? "Mindenkinek" : workshop.section}{" "}
      ...
      <div className="pt-1">
        <b>Elérhető helyek száma: </b> {workshop.noOfAvailableSeats}/{workshop.noOfTotalSeats}
