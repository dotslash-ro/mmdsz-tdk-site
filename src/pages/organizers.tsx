  ...
  return (
    <div className="px-5 py-20 md:mx-auto md:w-1/2 md:px-0">
      ...
      <p className="pb-10 text-sm font-semibold text-neutral-500">
        A 32. Marosvásárhelyi Tudományos Diákköri Konferenciára való szervezői jelentkezés 2024. december 16.-án
        kezdődik és 2024. december 20.-án, 23:59-kor ér véget.{" "}
        <a
