...
const Landing = () => {
  return (
    <>
      ...
      {/* <div className="bg-tdk-accent px-5 py-3 text-center text-sm font-semibold text-white underline shadow-md">
        <Link to="/hmaa">Jelentkezz az 57. HMAA Konferenciára!</Link>
      </div> */}
